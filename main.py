...
def main():
    ...
    parser.add_argument('--target-root', type=str, default='data/mnist_m/mnist_m_test')
    parser.add_argument('--target-list', type=str, default='data/mnist_m/mnist_m_test_labels.txt')
